  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #666; font-size: 12px; margin-top: 20px;">This tour request was submitted through the Springbase Schools website.</p>
      </div>
    `;
    ...
    console.log('SMTP tour email sent:', info?.messageId);
    return res.status(200).json({ success: true, message: 'Tour request submitted successfully', messageId: info?.messageId });
  } catch (error) {
